...
<body>
    ...
    <div id="assessmentPage" class="container">
        ...
        <label for="q2">คำถามที่ 2: คุณคิดว่ามีโอกาสมากน้อยเพียงใดที่จะกลับมาบาดเจ็บซ้ำบริเวณเข่าจากการเล่นกีฬา "0 :เป็นไปได้มากที่สุด 100 :ไม่มีความเป็นไปได้"</label>
        ...
        <label for="q3">คำถามที่ 3: คุณมีความกังวลเพียงใดเกี่ยวกับการเล่นกีฬา "0 :กังวลมากที่สุด 100 :ไม่มีความกังวลเลย"  </label>
        ...
        <label for="q4">คำถามที่ 4: คุณมั่นใจเพียงใดว่าจะไม่เกิดอาการเข่าหลวมจากการเล่นกีฬาอีก "0 :ไม่มั่นใจเลย 100 :มั่นใจมากที่สุด"</label>
        ...
        <label for="q5">คำถามที่ 5: คุณมั่นใจเพียงใดว่าคุณสามารถเล่นกีฬาได้โดยไม่ต้องกังวลเกี่ยวกับการบาดเจ็บของเข่า "0 :ไม่มั่นใจเลย 100 :มั่นใจมากที่สุด"</label>
        ...
        <label for="q6">คำถามที่ 6: คุณรู้สึกหงุดหงิดเพียงใด ที่ต้องนึกถึงเข่าที่บาดเจ็บเวลาเล่นกีฬา "0 :หงุดหงิดมากที่สุด 100 :ไม่หงุดหงิดเลย"</label>
        ...
        <label for="q7">คำถามที่ 7: คุณกลัวเพียงใดว่าจะเกิดการบาดเจ็บซ้ำบริเวณเข่าจากการเล่นกีฬา "0 :กลัวมากที่สุด 100 :ไม่กลัวเลย"</label>
        ...
        <label for="q8">คำถามที่ 8: คุณมั่นใจเพียงใดว่าเข่าของคุณสามารถรับแรงกระแทกได้ "0 ไม่มั่นใจเลย 100 :ไม่กังวลเลย"</label>
        ...
        <label for="q9">คำถามที่ 9: คุณกลัวเพียงใดว่าจะบาดเจ็บบริเวณเข่าโดยไม่ตั้งใจจากการเล่นกีฬา "0 :กลัวมากที่สุด 100 :ไม่กลัวเลย"</label>
        ...
        <label for="q10">คำถามที่ 10: คุุณคิดว่าการผ่าตัดและการฟื้นฟูร่างกายเป็นอุปสรรคต่อการกลับไปเล่นกีฬาเพียงใด "0 :คิดตลอดเวลา 100 :ไม่เคยคิดเลย"  </label>
        ...
        <label for="q11">คำถามที่ 11: คุณมั่นใจเพียงใดว่าจะแสดงความสามารถทางกีฬาได้อย่างดี "0 :ไม่มั่นใจเลย 100 :มั่นใจมากที่สุด" </label>
        ...
        <label for="q12">คำถามที่ 12: คุณรู้สึกผ่อนคลายเพียงใดเมื่อเล่นกีฬา "0 :ไม่ผ่อนคลายเลย 100 :ผ่อนคลายมากที่สุด"</label>
